...
public class BattleSessionConfigTest
{
    ...
    {
        var config = new BattleSessionConfig { OriginScene = "res://scenes/ui/screens/campaign_map.tscn" };
        AssertThat(config.OriginScene).IsEqual("res://scenes/ui/screens/campaign_map.tscn");
    }
