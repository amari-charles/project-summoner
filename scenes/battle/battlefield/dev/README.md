...
**Configuration:**
Configured via `TestBattleScene` (extends `BattleScene`). See `scripts/csharp/Battle/View/Debug/TestBattleScene.cs`.
...
```csharp
// scripts/csharp/Battle/View/Debug/TestAiScene.cs
[GlobalClass]
