...
const PANEL_SCENES: Dictionary = {
	EventTypeIDs.BATTLE: preload("res://scenes/ui/components/node_panels/battle_node_panel.tscn"),
	EventTypeIDs.CARAVAN: preload("res://scenes/ui/components/node_panels/caravan_node_panel.tscn"),
	EventTypeIDs.CHOICE: preload("res://scenes/ui/components/node_panels/choice_node_panel.tscn"),
	EventTypeIDs.AFFINITY: preload("res://scenes/ui/components/node_panels/onboarding_node_panel.tscn"),
	EventTypeIDs.FIRST_SUMMON: preload("res://scenes/ui/components/node_panels/onboarding_node_panel.tscn"),
	EventTypeIDs.ONBOARDING: preload("res://scenes/ui/components/node_panels/onboarding_node_panel.tscn"),
}
