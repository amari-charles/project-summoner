...
public static class ShopCatalog
{
    ...
    private static ShopDefinition BuildGeneralShop() => new()
    {
        Id = "general",
    ...
    private static ShopDefinition BuildCaravanTutorialShop() => new()
    {
        Id = "caravan_tutorial",
    ...
    private static ShopDefinition BuildPremiumStore() => new()
    {
        Id = "premium_store",
