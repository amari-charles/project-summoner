...
/// </summary>
public readonly record struct OfferingId(string Value)
{
    ...
    public static implicit operator string(OfferingId id) => id.Value;

    /// <summary>Explicit conversion from string.</summary>
    public static explicit operator OfferingId(string value) => new(value);

    /// <summary>Check if this ID has a value (not empty).</summary>
    public bool HasValue => !string.IsNullOrEmpty(Value);

    /// <summary>Empty/unset offering ID.</summary>
    public static readonly OfferingId None = new("");
}
