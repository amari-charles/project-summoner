...
/// </summary>
public readonly record struct BattleId(string Value)
{
    ...
    public static implicit operator string(BattleId id) => id.Value;
    ...
    /// <summary>Empty/unset battle ID.</summary>
    public static readonly BattleId None = new("");
}
