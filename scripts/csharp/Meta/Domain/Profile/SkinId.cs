...
public readonly record struct SkinId(string Value)
{
    ...
    public static implicit operator string(SkinId id) => id.Value;
    ...
    /// <summary>Empty/unset skin ID.</summary>
    public static readonly SkinId None = new("");
}
