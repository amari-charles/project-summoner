...
public partial class ItemService : Node
{
    ...
    {
        return _equipment?.GetEquippedItems(summonerId)
    ...
    /// </summary>
    private static StatModifier? ConvertTraitModifierToStatModifier(
        TraitModifier traitMod,
        string summonerId
    )
    {
        var statMod = new StatModifier { Source = traitMod.Source ?? $"item_{summonerId}" };
    ...
    /// </summary>
    public Godot.Collections.Array<Godot.Collections.Dictionary> GetEquippedItemStatModifiersDict(
        string summonerId
    )
    {
    ...
    public Godot.Collections.Array<Godot.Collections.Dictionary> GetOwnedItemsDict(
        string summonerId
    )
    {
        var result = new Godot.Collections.Array<Godot.Collections.Dictionary>();
        ...
        foreach (var item in GetOwnedItems(summonerId))
        {
            ...
            dict["equipped_by"] =
                item.EquippedBySummonerId != null ? (string)item.EquippedBySummonerId : "";
    ...
    public Godot.Collections.Array<Godot.Collections.Dictionary> ListItemsForSlotDict(
        string slotName,
        string summonerId
    )
    {
