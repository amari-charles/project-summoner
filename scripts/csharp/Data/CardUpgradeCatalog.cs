...
{
    public CardUpgradeId Id { get; set; } = CardUpgradeId.None;
...
public static class CardUpgradeCatalog
{
    ...
    /// </summary>
    public static CardUpgrade? GetUpgrade(string catalogId, CardUpgradeId upgradeId)
    {
        if (!Upgrades.TryGetValue(catalogId, out var cardUpgrades))
        {
    ...
    /// <summary>
    /// Get a specific upgrade by string ID.
    /// </summary>
    public static CardUpgrade? GetUpgrade(string catalogId, string upgradeId) =>
        GetUpgrade(catalogId, new CardUpgradeId(upgradeId));
    ...
    /// </summary>
    public static List<CardUpgradeId> GetAllUpgradeIds(string catalogId)
    {
        var ids = new List<CardUpgradeId>();
    ...
    /// </summary>
    private static CardUpgrade? FindGenericUpgrade(string catalogId, CardUpgradeId upgradeId)
    {
