...
public static class ProjectileMovement
{
    ...
    public static void TickStraight(SimProjectileData proj, float delta, Func<int, SimVector3?>? getTargetPosition = null)
    {
    ...
    /// </summary>
    public static void TickArc(SimProjectileData proj, float delta, Func<int, SimVector3?>? getTargetPosition = null)
    {
        if (proj.Tracking && getTargetPosition != null)
        {
            var targetPos = getTargetPosition(proj.TargetUnitId);
            ...
            {
                proj.TargetPosition = targetPos.Value;
                proj.PathLength = EstimateArcLength(proj.StartPosition, proj.TargetPosition, proj.ArcHeight);
            }
        }
    ...
    /// </summary>
    public static void SteerToward(SimProjectileData proj, SimVector3 targetDirection, float delta, float steerScale = 1f)
    {
    ...
    public static SimVector3 ApplyHomingWeave(SimProjectileData proj, SimVector3 toTarget)
    {
        ...
        float phase = (proj.TimeAlive * WeavingHomingTuning.HomingWeaveFrequency) + (proj.ProjectileId * HomingWeavePhaseOffset);
    ...
    public static SimVector3 BlendWithTarget(SimProjectileData proj, SimVector3 weaveDirection, float targetWeight)
    {
    ...
    public static SimVector3 ComputeArcControlPoint(SimVector3 start, SimVector3 end, float arcHeight)
    {
    ...
    /// </summary>
    public static void InitBallistic(SimProjectileData proj, SimVector3 start, SimVector3 end, float speed)
    {
