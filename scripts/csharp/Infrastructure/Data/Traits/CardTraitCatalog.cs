...
public static class CardTraitCatalog
{
    ...
    private static readonly Dictionary<string, Dictionary<int, List<CardTrait>>> Traits = new()
    {
        ...
        ["fireball"] = new Dictionary<int, List<CardTrait>>
        {
            ...
            [3] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_expanded_3"),
                    Name = "Expanded Blast",
                    Description = "+12% Radius",
            ...
            [4] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_conflagration_4"),
                    Name = "Conflagration",
            ...
            [5] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_firestorm_5"),
                    Name = "Firestorm",
                    Description = "+18% Radius",
                    StatMods = new() { ["spell_radius"] = 1.18f },
                },
                new()
                {
                    Id = new("fireball_balanced_5"),
                    Name = "Refined Casting",
                    Description = "+10% Damage, +10% Radius",
            ...
            [6] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_wildfire_6"),
                    Name = "Wildfire",
                    Description = "+20% Radius",
            ...
            [7] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_devastation_7"),
                    Name = "Devastation",
                    Description = "+22% Radius",
                    StatMods = new() { ["spell_radius"] = 1.22f },
                },
                new()
                {
                    Id = new("fireball_efficient_7"),
                    Name = "Efficient Casting",
                    Description = "+15% Damage, +12% Radius",
            ...
            [8] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_apocalypse_8"),
                    Name = "Apocalyptic Blast",
                    Description = "+25% Radius",
            ...
            [9] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("fireball_nova_9"),
                    Name = "Supernova",
                    Description = "+28% Radius",
                    StatMods = new() { ["spell_radius"] = 1.28f },
                },
                new()
                {
                    Id = new("fireball_mastery_9"),
                    Name = "Fire Mastery",
                    Description = "+20% Damage, +18% Radius",
            ...
            [10] = new List<CardTrait>
            {
                new()
                {
                    Id = new("fireball_apex_power_10"),
                    Name = "Apex Destruction",
                    Description = "+40% Damage",
                    StatMods = new() { ["spell_damage"] = 1.40f },
                },
                new()
                {
                    Id = new("fireball_apex_area_10"),
                    Name = "Apex Devastation",
                    Description = "+32% Radius",
                    StatMods = new() { ["spell_radius"] = 1.32f },
                },
                new()
                {
                    Id = new("fireball_apex_perfect_10"),
                    Name = "Perfect Inferno",
                    Description = "+25% Damage, +25% Radius",
        ...
        ["charge"] = new Dictionary<int, List<CardTrait>>
        {
            [2] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_swift_2"),
                    Name = "Swift Charge",
                    Description = "+12% Effect Speed",
            ...
            [3] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_coordinated_3"),
                    Name = "Coordinated Strike",
                    Description = "+10% Damage, +8% Speed",
            ...
            [4] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_lightning_4"),
                    Name = "Lightning Charge",
                    Description = "+18% Effect Speed",
            ...
            [5] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_blitz_5"),
                    Name = "Blitz",
                    Description = "+22% Effect Speed",
                    StatMods = new() { ["move_speed"] = 1.22f },
                },
                new()
                {
                    Id = new("charge_tactical_5"),
                    Name = "Tactical Excellence",
                    Description = "+12% Damage, +12% Speed",
            ...
            [6] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_rapid_6"),
                    Name = "Rapid Assault",
                    Description = "+25% Effect Speed",
            ...
            [7] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_thunder_7"),
                    Name = "Thunder Strike",
                    Description = "+28% Effect Speed",
                    StatMods = new() { ["move_speed"] = 1.28f },
                },
                new()
                {
                    Id = new("charge_supreme_7"),
            ...
            [8] = new List<CardTrait>
            {
                new()
                {
                    Id = new("charge_decimating_8"),
                    Name = "Decimating Assault",
                    Description = "+32% Damage",
                    StatMods = new() { ["spell_damage"] = 1.32f },
                },
                new()
                {
                    Id = new("charge_sonic_8"),
                    Name = "Sonic Charge",
                    Description = "+32% Effect Speed",
            ...
            [9] = new List<CardTrait>
            {
                new()
                {
                    Id = new("charge_legendary_dmg_9"),
                    Name = "Legendary Assault",
                    Description = "+35% Damage",
                    StatMods = new() { ["spell_damage"] = 1.35f },
                },
                new()
                {
                    Id = new("charge_legendary_spd_9"),
                    Name = "Legendary Speed",
                    Description = "+35% Effect Speed",
                    StatMods = new() { ["move_speed"] = 1.35f },
                },
                new()
                {
                    Id = new("charge_legendary_bal_9"),
                    Name = "Perfect Charge",
                    Description = "+20% Damage, +20% Speed",
            ...
            [10] = new List<CardTrait>
            {
                ...
                new()
                {
                    Id = new("charge_apex_speed_10"),
                    Name = "Apex Velocity",
                    Description = "+40% Effect Speed",
                    StatMods = new() { ["move_speed"] = 1.40f },
                },
                new()
                {
                    Id = new("charge_apex_perfect_10"),
                    Name = "Ultimate Command",
                    Description = "+25% Damage, +25% Speed",
    ...
    public static List<CardTrait> GetTraitsForLevel(string catalogId, int level)
    {
        if (!Traits.TryGetValue(catalogId, out var cardTraits))
        {
            ...
            {
                GD.PushWarning(
                    $"CardTraitCatalog: No traits defined for card '{catalogId}' at level {level}"
                );
            }
