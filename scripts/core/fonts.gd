extends Node
## Fonts - Preloaded font resources for easy access throughout the game
...
# Display font (Germania One) - use for titles, headers, logos
const TITLE: FontFile = preload("res://assets/fonts/germania_one/GermaniaOne-Regular.ttf")
