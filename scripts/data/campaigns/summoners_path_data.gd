	...
	return [
		...
		# Battle 1: First Trial - Learn basics with 1 card
		{
			...
			"data": {
				...
				"reward_options": [CardIDs.CHARGE, CardIDs.FIRE_ELEMENTAL, CardIDs.PUFF],
				"player_selects": true,
				"gold_reward": 30,
				"enemy_deck": [
		...
		# Battle 3: Third Trial - Medium difficulty
		{
			...
			"data": {
				...
				"requires_deck": true,
				"reward_type": RewardTypeIDs.FLEXIBLE,
				"reward_options": [CardIDs.FIRE_ELEMENTAL, CardIDs.CHARGE, CardIDs.CLOUD_SWARM],
				"player_selects": true,
				"gold_reward": 50,
				"enemy_deck": [
					{"catalog_id": CardIDs.PUFF, "count": 2},
...

		{
			...
			"data": {
				...
				"level_cap": 3,
				"reward_type": RewardTypeIDs.FLEXIBLE,
				"reward_options": [CardIDs.FIRE_ELEMENTAL, CardIDs.CHARGE, CardIDs.MANA_BOLT],
				"player_selects": true,
				"gold_reward": 80,
				"enemy_deck": [
