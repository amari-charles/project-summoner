...
- `scenes/battle/battlefield/components/base_battlefield_3d.tscn` - Battlefield scene with spawn markers
...
- `scenes/battle/battlefield/dev/test_battle_vfx.tscn` - VFX test battle setup
